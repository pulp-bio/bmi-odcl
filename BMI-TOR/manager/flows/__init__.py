...
from .test_multi_select_TOR import test_multi_select_TOR
from .test_multi_select_TOR_merge import test_multi_select_TOR_merge
from .test_multi_select_TOR_long_chain import test_multi_select_TOR_long_chain
from .test_multi_select_TOR_long_chain_merge import test_multi_select_TOR_long_chain_merge
from .test_multi_select_TOR_long_chain_check_all_test_acc import test_multi_select_TOR_long_chain_check_all_test_acc
from .quantize  import quantize
from .train_ER  import train_ER
from .train_ER_single  import train_ER_single
from .train_TL  import train_TL
from .train_LwF import train_LwF
from .train_TL_sliding  import train_TL_sliding
from .train_TL_sliding_best  import train_TL_sliding_best
from .train_TL_on_request  import train_TL_on_request
from .train_TL_on_request_withPretrained  import train_TL_on_request_withPretrained
from .train_TL_on_request_withPretrained_prev_sessions import train_TL_on_request_withPretrained_prev_sessions
from .train_LwF_on_request_withPretrained  import train_LwF_on_request_withPretrained
from .train_LwF_on_request_withPretrained_prev_sessions import train_LwF_on_request_withPretrained_prev_sessions
from .train_ER_on_request_withPretrained_prev_sessions_long_chain import train_ER_on_request_withPretrained_prev_sessions_long_chain
from .train_TL_on_request_withPretrained_prev_sessions_long_chain import train_TL_on_request_withPretrained_prev_sessions_long_chain
from .train_LwF_on_request_withPretrained_prev_sessions_long_chain import train_LwF_on_request_withPretrained_prev_sessions_long_chain
from .train_TL_on_request_withPretrained_prev_sessions_long_chain_test_acc import train_TL_on_request_withPretrained_prev_sessions_long_chain_test_acc
from .train_ER_on_request_withPretrained_prev_sessions_long_chain_test_acc import train_ER_on_request_withPretrained_prev_sessions_long_chain_test_acc
from .train_LwF_on_request_withPretrained_prev_sessions_long_chain_test_acc import train_LwF_on_request_withPretrained_prev_sessions_long_chain_test_acc
from .train_TL_on_request_withPretrained_prev_sessions_long_chain_ori_method import train_TL_on_request_withPretrained_prev_sessions_long_chain_ori_method
from .train_LwF_on_request_withPretrained_prev_sessions_long_chain_ori_method import train_LwF_on_request_withPretrained_prev_sessions_long_chain_ori_method
from .train_ER_on_request_withPretrained_prev_sessions_long_chain_ori_method import train_ER_on_request_withPretrained_prev_sessions_long_chain_ori_method
