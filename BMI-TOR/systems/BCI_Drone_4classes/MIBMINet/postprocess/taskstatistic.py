...
from systems.BCI_Drone_4classes.utils.statistics import BCIDroneStatistic
...
class MIBMINetStatistic(BCIDroneStatistic):

    def __init__(self,
                 platform: PlatformManager, writerstub: WriterStub,
                 n_epochs: int, n_batches: int,
                 train: bool):
        super(MIBMINetStatistic, self).__init__(platform=platform, writerstub=writerstub,
