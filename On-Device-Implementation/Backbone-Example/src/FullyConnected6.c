...
void __attribute__ ((noinline)) FullyConnected6(void *args) {
  ...
  const Layer layer = {
    .addr = {
      ...
      .bias = layer_args->L2_weights + 1856,
  ...
  DoubleBuffer db_input = {
    .addrs = { l1_buffer + 0, l1_buffer + 0 + 928 },
    .index = 0
  };
  DoubleBuffer db_output = {
    .addrs = { l1_buffer + 936, l1_buffer + 936 + 8 },
    .index = 0
  };
  DoubleBuffer db_weights = {
    .addrs = { l1_buffer + 952, l1_buffer + 952 + 1856 },
    .index = 0
  };
  ...
  for(int iter=0; iter < total_tiles; iter++) {
    Address addr = {
      ...
      .bias = l1_buffer + 2832 + index.output_channel * 8,
