...
static inline void connect_blobs() 
{
  ...
  layer0_wgt_old.diff = l0_ker_diff; // placeholder
  ...
  layer0_bias_old.diff = l0_bias_diff; // placeholder
  ...
  layer0_out_old.diff = l0_out_diff; // placeholder

  layer0_out_div_T.data = l0_out_div_T;
  layer0_out_div_T.dim = Tout_l0;
  layer0_out_div_T.diff = l0_out_diff; // placeholder
  ...
  layer0_act_out_old.diff = l0_act_out_diff; // placeholder

  layer0_act_out_div_T.data = l0_act_out_div_T;
  layer0_act_out_div_T.dim = Tout_l0;
  layer0_act_out_div_T.diff = l0_act_out_diff; // placeholder
